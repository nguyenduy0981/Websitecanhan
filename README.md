...
game nhỏ và sưu tập thành tích cùng nhau.

**Phiên AI mới bắt đầu ở đây:** [`docs/AI_ENGINEERING_CONTEXT.md`](./docs/AI_ENGINEERING_CONTEXT.md)
— tài liệu onboarding chính thức duy nhất, đọc trước khi viết bất kỳ dòng
code nào.

Xem [`CLAUDE.md`](./CLAUDE.md) cho
các quy tắc thiết kế bắt buộc + nhật ký quyết định chi tiết,
[`docs/VO_TRI_DESIGN_BIBLE.md`](./docs/VO_TRI_DESIGN_BIBLE.md)
